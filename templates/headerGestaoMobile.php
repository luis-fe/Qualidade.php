...
<head>
  ...
  <style>
    ...
    /* --- CORREÇÃO CONFLITO BOOTSTRAP VS TAILWIND --- */
.collapse.show {
...
<nav class="navbar d-flex align-items-center">
  ...
  <div id="sidebar">
    ...
    <ul class="nav flex-column">
      ...
      <li class="nav-item">
    <a href="javascript:void(0)" data-bs-target="#submenuAlmoxarifado" data-bs-toggle="collapse" class="nav-link justify-content-between submenu-trigger" aria-expanded="false">
