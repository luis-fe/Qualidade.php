...
<footer class="footer" style="background-color: var(--Branco); font-size: 18px;">
    <div class="container-fluid">
        <div class="row text-muted">
            ...
            <div class="col-6 text-end mb-2 mt-2">
...
<script src="../../templates/script1.js"></script>
<script>
