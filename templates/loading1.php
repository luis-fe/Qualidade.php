...
<style>
    .modal-content {
        text-align: center;
        background-color: #f0f0f0; /* Background mais claro */
    ...
    .loader-icon {
        ...
        margin-bottom: 20px;
        animation: spin 4s linear infinite; /* Aumentei a duração da animação para 4 segundos */
    }
...
<script>
    $(document).ready(function() {
        $('#loadingModal').modal('show'); // Exibe o modal ao carregar a página
    });
</script>
