...
<div class="modal fade modal-custom" id="modal-imagemMP" tabindex="-1" aria-labelledby="customModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top modal-xl modal-grande">
        <div class="modal-content">
            ...
            <div class="modal-body" id="modal-body-imagem" style="text-align: center;">
...
<div id="informacoes-container" class="mt-3 div-informacoes mx-auto p-3 border border-dark rounded d-none" 
    ...
    <form>
        <button type="button" onclick="fecharInformacoes()" class="btn-close position-absolute top-0 end-0 m-2" aria-label="Fechar"></button> 
...
<div id="simulacao-container" class="mt-3 div-simulacao mx-auto d-none p-3 border border-dark rounded" 
    style="width: 60%; max-height: 80vh; overflow-y: auto; background-color: lightgray; position: fixed; top: 20px; left: 50%; transform: translateX(-50%); z-index: 1050;">
    
    <form>
        <button type="button" onclick="fecharSimulacao()" class="btn-close position-absolute top-0 end-0 m-2" aria-label="Fechar"></button> 
        ...
        <div class="px-3 pb-4"> 
            ...
            <div id="inputs-container-PRODUTOS" class="d-flex align-items-center gap-2"> 
                <button type="button" class="btn btn-primary" id="btn-adicionar-lotes" onclick="Consulta_Engenharias()"> 
                    <i class="bi bi-plus"></i> 
                    <span style="font-size: 12px;">Escolher</span> 
                </button> 
                <span id="TituloSelecaoEngenharias">Todas Selecionadas</span> 
                <button type="button" class="btn btn-danger d-flex flex-column align-items-center justify-content-center" id="btn-limpar-lotes" onclick="Deletar_SimulacaoProduto()"> 
        ...
        <div class="modal-footer"> 
            <button type="button" class="btn btn-danger" onclick="Deletar_Simulacao()"> 
                <i class="bi bi-trash3-fill"></i> Excluir Simulação 
            </button> 
            <button type="button" class="btn btn-success" onclick="simulacao($('#select-simulacao').val(),''); return false;"> 
...
<div class="modal fade modal-custom" id="modal-detalhamento-pedidos" tabindex="-1" aria-labelledby="customModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body" style="align-items: start; text-align: left">
                ...
                <div class="custom-pagination-container pagination-detalhamento d-md-flex col-12 text-center text-md-start">
                    ...
                    <div id="pagination-detalhamento-pedidos" class="col-12 col-md-6 d-flex justify-content-center justify-content-md-end"></div>
                </div>
            </div>
        </div>
    </div>
...
<div class="modal fade modal-custom" id="modal-detalhamento-OrdemProd" tabindex="-1" aria-labelledby="customModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top modal-xl">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body" style="align-items: start; text-align: left">
                ...
                <div class="custom-pagination-container pagination-detalhamento d-md-flex col-12 text-center text-md-start">
                    ...
                    <div id="pagination-detalhamento-OrdemProd" class="col-12 col-md-6 d-flex justify-content-center justify-content-md-end"></div>
                </div>
            </div>
        </div>
    </div>
...
<div class="modal fade modal-custom" id="modal-detalhamento-pedidosSaldo" tabindex="-1" aria-labelledby="customModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top modal-xl">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body" style="align-items: start; text-align: left">
                ...
                <div class="custom-pagination-container pagination-detalhamento d-md-flex col-12 text-center text-md-start">
                    ...
                    <div id="pagination-detalhamento-pedidosSaldo" class="col-12 col-md-6 d-flex justify-content-center justify-content-md-end"></div>
                </div>
            </div>
        </div>
    </div>
...
<div id="modal-selecaoEngenharias" class="mt-3 div-selecaoEngenharias mx-auto d-none p-3 border border-dark rounded" 
    ...
    <div class="modal-header">
        ...
        <button type="button" onclick="fecharselecaoEngenharia()" class="btn-close position-absolute top-0 end-0 m-2" aria-label="Fechar"></button> 
    </div>
    ...
    <div class="modal-body" style="min-width: 100%; max-height: 100%; overflow: auto">
        ...
        <div class="custom-pagination-container pagination-lotes-csw d-md-flex col-12 text-center text-md-start">
            ...
            <div id="pagination-lotes-csw" class="col-12 col-md-6 d-flex justify-content-center justify-content-md-end"></div>
        </div>
    </div>
    
    <div class="modal-footer">
        <button class="btn btn-salvar" style="width: 100px" id="btn-salvarProdutosSimulacao">
            <span><i class="bi bi-floppy"></i></span> Salvar
        </button>
    </div>
</div>

<div class="modal fade modal-custom" id="modal-detalhamento-simulacaoSku" tabindex="-1" aria-labelledby="customModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top modal-xl">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body" style="align-items: start; text-align: left">
                ...
                <div class="custom-pagination-container pagination-detalhamento d-md-flex col-12 text-center text-md-start">
                    ...
                    <div id="pagination-detalhamento-skus" class="col-12 col-md-6 d-flex justify-content-center justify-content-md-end"></div>
                </div>
            </div>
        </div>
    </div>
