    ...
    <div id="main-card" class="w-full max-w-md bg-white p-6 rounded-xl shadow-sm border border-gray-200 transition-colors duration-300">
        ...
        <div id="step-1">
            <div class="mb-6 text-center border-b border-gray-100 pb-4">
                <h2 class="text-2xl font-bold text-gray-800">Reposição de Aviamentos</h2>
                <p class="text-sm text-gray-500 mt-1">Selecione o tipo e informe o endereço</p>
            </div>
            ...
            <div class="mb-4">
                ...
                <div class="flex space-x-2">
                    <input type="text" id="endereco" placeholder="Ex: A-10-05" class="flex-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 text-lg px-4 py-3 border">
