$(document).ready(async () => {
    ...
    let table = $('#table-metas').DataTable(); // Certifique-se de capturar a instância
    ...
    $('#table-metas tbody').on('click', 'button.btn-detalhes', function() {
        ...
        if (row.child.isShown()) {
            ...
            // Abre a linha filha com o formulário
...
function formatarDetalhes(row) {
    // row é o objeto com os dados da linha atual
    return `
        <div class="p-3 border-start border-primary border-4 bg-light">
            <h6 class="fw-bold text-primary mb-3">Configurações do Material: ${row.DESCRICAO_MATERIAL || ''}</h6>
            <div class="row g-3">
                <div class="col-md-2">
                    <label class="form-label small fw-bold">Saldo Destacado</label>
                    <input type="text" class="form-control form-control-sm border-secondary" readonly value="${row.SALDO_REPOR || 0}">
                </div>
                <div class="col-md-2">
                    <label class="form-label small fw-bold">Kit 1 (Tamanho)</label>
                    <input type="number" class="form-control form-control-sm" placeholder="Qtd Kit 1">
                </div>
                <div class="col-md-2">
                    <label class="form-label small fw-bold">Kit 2 (Tamanho)</label>
                    <input type="number" class="form-control form-control-sm" placeholder="Qtd Kit 2">
                </div>
                <div class="col-md-2">
                    <label class="form-label small fw-bold">Kit 3 (Tamanho)</label>
                    <input type="number" class="form-control form-control-sm" placeholder="Qtd Kit 3">
                </div>
                <div class="col-md-2">
                    <label class="form-label small fw-bold">Granel (Padrão 1)</label>
                    <input type="number" class="form-control form-control-sm" value="1">
                </div>
                <div class="col-md-2 d-flex align-items-end">
                    <button class="btn btn-sm btn-success w-100" onclick="salvarConfigKit('${row.CODIGO_MATERIAL}')">
                        <i class="bi bi-check-lg"></i> Imprimir Etiquetas Kit
                    </button>
                </div>
            </div>
        </div>
