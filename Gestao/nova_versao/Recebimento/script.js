...
async function salvarConfigKit(codID, btnElement) {
    ...
    itensParaImprimir.forEach(item => {
        ...
        const cardHTML = `
            <div class="card card-etiqueta" style="border: none; background-color: #fff; margin: 0; padding: 0; border-radius: 0; width: 10.1cm; height: 2.6cm; page-break-after: always; box-sizing: border-box;">
                <div class="card-body d-flex flex-row align-items-center justify-content-between p-1" style="height: 100%; gap: 0.2cm; padding-left: 0.2cm !important; padding-right: 0.2cm !important;">
                    
                    <div class="d-flex flex-column justify-content-center" style="width: 7cm; overflow: hidden; font-family: Arial, sans-serif;">
                        <strong style="font-size: 16px; color: #000; line-height: 1.1;">${item.codigo}</strong>
                        ...
                        <div class="d-flex justify-content-between align-items-end" style="margin-top: 2px;">
                            ...
                            <span style="font-size: 10px; color: #555; line-height: 1.1;">Imp: ${dataAtual}</span>
                        </div>
                    </div>
