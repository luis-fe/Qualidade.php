...
<div class="col-12">
  <section class="frame frame-indicadores">
    ...
    <div class="busca-avancada position-relative">
...
<!-- ============================================================
     Frame 2 — Índice de 2ª Qualidade (medidor limitado pela meta)
     ============================================================ -->
<div class="col-12 mt-3">
  <section class="frame frame-indice">
    ...
    <div class="frame-indice-corpo">
      ...
      <div class="leituras">
        ...
        <div class="leitura leitura--status">
          <span class="situacao" id="indiceSituacao">—</span>
        </div>
      </div>
