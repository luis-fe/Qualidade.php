...
const cardHTML = `
    <div class="card card-etiqueta" style="background-color: #fff; border: none; overflow: hidden; width: 10.0cm; height: 3.0cm; margin-top: 1.0cm;">
        <div class="card-body-custom d-flex flex-row align-items-start" style="height: 100%; padding: 0.1cm 0.5cm 0.1cm 0.5cm; box-sizing: border-box;">
