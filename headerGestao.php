...
<head>
  ...
  <style>
    ...
    .sidebar-links-direita .nav-link {
      color: white;
      font-weight: 500;
      margin-bottom: 5px;
      border-radius: 7px;
    ...
    .sidebar-links-direita .nav-link:hover {
      background-color: rgba(255, 255, 255, 0.15);
    }
  </style>
</head>
...
<body>
  ...
  <div id="sidebar">
    ...
    <ul class="nav flex-column">
      ...
      <li class="nav-item">
        ...
        <div class="collapse" id="submenuAlmoxarifado">
          <ul class="submenu-list">
            <li>
              <a href="#painelGestaoEnderecos" data-bs-toggle="offcanvas" class="nav-link btn-abre-direita" role="button" aria-controls="painelGestaoEnderecos">
                <i class="bi bi-caret-right me-2"></i> Gestão Endereço
              </a>
            </li>
      ...
      <li class="nav-item">
        <a href="#submenuMobileAviamentos" data-bs-toggle="collapse" class="nav-link justify-content-between" aria-expanded="false">
          <span><i class="bi bi-caret-right-fill icon-main"></i> Mobile Aviamentos</span>
          <i class="bi bi-chevron-down rotate-icon"></i>
        </a>
        <div class="collapse" id="submenuMobileAviamentos">
          <ul class="submenu-list">
            <li><a href="../MobileAviamentos/Modulos/Reposicao" class="nav-link"><i class="bi bi-caret-right me-2"></i> Reposicao</a></li>
            <li><a href="../GestaoEnderecos" class="nav-link"><i class="bi bi-caret-right me-2"></i> Consulta Endereco</a></li>
          </ul>
        </div>
      </li>
  ...
  <div class="offcanvas offcanvas-end" tabindex="-1" id="painelGestaoEnderecos" aria-labelledby="painelGestaoEnderecosLabel" style="background-color: #10045a; color: white;">
    <div class="offcanvas-header border-bottom border-secondary">
      <h5 class="offcanvas-title fw-bold" id="painelGestaoEnderecosLabel">
        <i class="bi bi-geo-alt me-2 text-info"></i>Gestão de Endereços
      </h5>
      <button type="button" class="btn-close btn-close-white" data-bs-dismiss="offcanvas" aria-label="Close"></button>
    </div>
    
    <div class="offcanvas-body">
      <ul class="nav flex-column sidebar-links-direita">
        <li>
          <a href="../IncluirExcluirEndereco" class="nav-link">
            <i class="bi bi-plus-circle icon-main"></i> Incluir/Excluir Endereço
          </a>
        </li>
        <li>
          <a href="../ConsultarEnderecos" class="nav-link">
            <i class="bi bi-search icon-main"></i> Consultar Endereços
          </a>
        </li>
        <li>
          <a href="../MapaEndereco" class="nav-link">
            <i class="bi bi-map icon-main"></i> Mapa de Endereço
          </a>
        </li>
      </ul>
    </div>
  ...
  <script>
    $(document).ready(function () {
      ...
      // Fechar o menu lateral esquerdo ao abrir o menu da direita
      $('.btn-abre-direita').on('click', function () {
        $('#sidebar').removeClass('ativo');
